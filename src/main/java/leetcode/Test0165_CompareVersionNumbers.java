...
public class Test0165_CompareVersionNumbers {
    ...
    public void test() {
        ...
        testMap.put(new String[]{"1","1.1"}, -1);
        testMap.entrySet().stream()
                .filter(entry -> !entry.getValue().equals(compareVersion(entry.getKey()[0], entry.getKey()[1])))
                .findAny()
